...
if((!empty($_REQUEST['csst']))AND(!is_numeric($_REQUEST['csst']))==true) { die("an error has occured"); } 
...
.the-addbutton { width: 64px; height: 36px; font-size: initial; background-color: #25d725; border: none; border-radius: 4px;}
.the-addbutton:hover { opacity: 1; cursor: pointer; text-decoration: none;} 
...
<!-- #viewcartminilinks a  {
	background: #<?php //print $css['submit_bg'];?>; border: solid 1px #<?php //print $css['submit_border'];?>;color: #<?php //print $css['submit_text'];?>!important; display: block; padding: 8px; text-align: center; margin-bottom: 8px;
} --> 
...
<!-- #viewcartminilinks a:hover {  
	...
	color: #<?php //print $css['submit_hover_text'];?>!important;
} -->
...
.headerheight { height: <?php print $css['header_height'];?>px;  } 
.headerheightmobile { height: <?php print $css['mobile_header_height'];?>px; } 


<?php if(($css['menu_placement'] == "left")OR($css['menu_placement'] == "right")OR($css['menu_placement'] == "rightleft")==true)  { ?>
#headerAndMenu { 
	position: relative;
...
<?php } elseif($css['menu_placement'] == "right") { ?>
	float: left;
	width: auto;
<?php } elseif($css['menu_placement'] == "rightleft") { ?>
	float: left;
	width: auto;
<?php } else { ?>
	 <?php if($css['header_wide'] == 1) { ?>
...
font-family:'<?php print $css['header_font'];?>'; font-size:<?php print $css['header_font_size'];?>px; 
}
#header img {
	display: inline;
}
...
#photoprods, #photocrop, #photopackagecontainer  { display: none; background: <?php print inside_bg;?>; width: 100%; max-width: 800px; left: 50%; margin-left: -400px; border: solid 1px #<?php print $css['outside_bg'];?>; position: absolute; z-index: 200; box-shadow: 0 0 8px rgba(0,0,0,.5); } 
...
#photoproductsnexttophotobg { display: none; position: fixed;  right: 0; top: 0; width: 28%; float: right; background: <?php print inside_bg;?>; height:100%;   z-index: 19; } 
#photoproductsnexttophoto { display: none; position: relative;  right: 0; top: 0; width: 28%; float: right; background: <?php print inside_bg;?>; height:100%;   z-index: 20; } 
...
<?php $rgb = hex2rgb($css['full_screen_background']); ?>
#mlsignuppopup { z-index: 900; } 
.signupbg { position: fixed; background-color: rgba(<?php print $rgb[0];?>,<?php print $rgb[1];?>,<?php print $rgb[2];?>,.95); top: 0; left: 0; width: 100%; height: 100%; z-index: 900; } 
.signupcontainer { position: fixed; top: 35%; left: 0; background:<?php print inside_bg;?>; width: 100%;z-index: 920; } 
.signupcontainerinner { padding: 24px; text-align: center; color: <?php print font_color;?>;z-index: 920;}
...
#mobilemenubuttontop { 
 padding-top: <?php print $css['header_padding_tb'];?>px; 
 padding-bottom: <?php print $css['header_padding_tb'];?>px;
 font-size: 24px;
 display: none;
}
#mobilemenubuttontop .icon-menu { font-size: 30px; } 
#mobilemenubuttontop .menutext { padding: 0px; position: relative; top: -2px; } 
#mobilemenubuttontop .the-icons { text-shadow: none;  color: <?php print menu_link_color;?>} 
...
<?php ie8rgba($css['menu_color'],$css['menu_opacity']) ?>
	...
	border: 1px solid <?php print menu_border_b;?> 0px;
	font-size: 27px;
	z-index: 20;
	color: <?php print menu_link_color;?>;
	position: relative;
}
#mobilemenu .the-icons { color: <?php print menu_link_color;?>;  text-shadow: none; }
...
#topMainMenu a .the-icons  { 
	font-size: <?php print $css['footer_menu_font_size'];?>px;
	color: <?php print menu_link_color;?>;
<?php if($css['menu_text_shadow_on'] == "1") { print "text-shadow: ".$css['menu_text_shadow'].";"; } else { print "text-shadow: none;"; } ?>

}
#topMainMenu a .the-icons:hover {   color: <?php print menu_link_hover;?>; text-decoration: none;   } 
...
#shopmenu .the-icons, #accountmenu .the-icons { 
	color: #<?php print $css['sm_link_color'];?>;
	font-size: <?php print $css['sm_font_size'];?>px;
	<?php if($css['sm_text_shadow_on'] == "1") { print "text-shadow: ".$css['sm_text_shadow'].";"; } else { ?>text-shadow: none; <?php } ?>
}
#shopmenu .the-icons:hover, #accountmenu .the-icons:hover { 
	 color: #<?php print $css['sm_link_hover'];?>; 
}
...
#listing-standard .preview .thumbnail, #listing-standard .preview .thumbnailnoborder { width: 100%; max-width: <?php print $css['boxes_img_width'];?>px; height: auto; } 
.preview .image {  }
...
.thumbactionsstacked .thumbnailactions .inner .the-icons  { color: #<?php print $css['on_photo_title']; ?>; opacity: .6;  text-shadow: #<?php print $css['on_photo_text_bg'];?> 0px 0px 2px;} 
...
#listing-stacked .preview {
	...
	border: <?php print $css['thumb_listing_border_size'];?>px <?php print $css['thumb_listing_border_style'];?> #<?php print $css['thumb_listing_border'];?>;
	color: #<?php print $css['thumb_listing_text'];?>;
	padding: <?php print $css['stacked_listing_padding'];?>px;
	margin: <?php print $css['thumb_listing_margin'];?>px;
	width: <?php print $css['thumb_listing_width'];?>px;
	<?php addBoxShadow($css['thumb_listing_box_shadow']);?>
	-moz-border-radius: <?php print $css['thumb_listing_border_radius'];?>px;	border-radius: <?php print $css['thumb_listing_border_radius'];?>px; 
...
#listing-stacked .preview div { padding: <?php print $css['stacked_listing_padding'] / 2;?>px; }
...
.backtoproductlist { } 
.addproducttocart .the-icons { color: #<?php print $css['submit_text'];?>; text-shadow: none; opacity: 1; } 
...
.photofull {
	margin: auto;
	border: solid <?php print $css['photo_border_size'] = 5;?>px <?php echo "#1ffc6e";?>; 
...
#footer {
	padding: <?php print $css['footer_padding'];?>px; 
	font-size: <?php print $css['footer_font_size'];?>px; 
	color: #<?php print $css['footer_text_color'];?>;
	background-color: #<?php print $css['footer_bg'];?>;
}
#footer .the-icons { 
	font-size: 32px;
}
...
#footer a,  #footer a:active { text-decoration: none; color: #<?php print $css['footer_link_color'];?>;}
#footer a:link, #footer a:visited {  text-decoration: none; color: #<?php print $css['footer_link_color'];?>;   }
#footer a:hover {  color: #<?php print $css['footer_link_hover'];?>; } 
...
#galleryheader {top: 0; left: 0; background: #<?php print $css['sm_background'];?>; color: #<?php print $css['sm_text'];?>; width: 100%; z-index: 20; } 
.galleryheaderfixed { position: fixed; } 
.galleryheader { position: relative; height: auto;} 

#galleryheader a, #galleryheader a:visited { color: #<?php print $css['sm_link_color'];?>; } 
#galleryheader a:hover { color: #<?php print $css['sm_link_hover'];?>; } 
...
#galleryheader .inner .menuouter .menu ul li a { color: #<?php print $css['sm_link_color'];?>; 	vertical-align: middle; 	white-space: nowrap; border-bottom: solid 2px transparent; } 
#galleryheader .inner .menuouter .menu ul li a:hover{ color: #<?php print $css['sm_link_hover'];?>; } 

#galleryheader .inner .menuouter .menu ul li a .the-icons { color: #<?php print $css['sm_link_color'];?>; text-shadow: none; 	white-space: nowrap;} 
#galleryheader .inner .menuouter .menu ul li .title { position: absolute; background: #<?php print $css['sm_link_color'];?>; color: #<?php print $css['sm_background'];?>; padding: 8px;  opacity: 0; display: none;} 
#galleryheader .inner .menuouter .menu ul li .on { border-bottom: solid 2px #<?php print $css['sm_link_color'];?>; color: #<?php print $css['sm_link_hover'];?>;} 

#gallerymobileheader {top: 0; left: 0; background: #<?php print $css['sm_background'];?>; color: #<?php print $css['sm_link_color'];?>; width: 100%; } 
...
#gallerymobileheader .inner ul li a { color: #<?php print $css['sm_link_color'];?>; 	vertical-align: middle; 	white-space: nowrap; border-bottom: solid 2px transparent; } 
#gallerymobileheader .inner  ul li a .the-icons { color:#<?php print $css['sm_link_color'];?>; text-shadow: none; 	white-space: nowrap; font-size: 19px;} 
...
#gallerymobilemenu .menu ul li a {  display:block; margin: 0px 0px 0px 0px; background: #<?php print $css['sm_background'];?>; border-bottom: solid 1px #<?php print $css['sm_border_bottom'];?>; padding: 16px; color: #<?php print $css['sm_link_color'];?>; } 
#gallerymobilemenu .menu ul li a .the-icons { color: #<?php print $css['sm_link_color'];?>; text-shadow: none; } 

.underlinemenu {  display:block; margin: 0px 0px 0px 0px; background: #<?php print $css['sm_background'];?>; border-bottom: solid 1px #<?php print $css['sm_border_bottom'];?>; padding: 16px; color: #<?php print $css['sm_link_color'];?>; } 


.gallerymenuicon { font-size: 31px; text-shadow: none; color:#<?php print $css['sm_link_color'];?>; } 
...
.gallerypopup .inner ul li a, .stylelist .inner ul li a {  display:block; margin: 0px 0px 0px 0px; background: #<?php print $css['boxes'];?>; border-bottom: solid 1px #<?php print $css['boxes_borders'];?>; padding: 16px; color: #<?php print $css['boxes_text'];?>;  } 
.gallerypopup .inner ul li a .the-icons, .stylelist .inner ul li a .the-icons{ color: #<?php print $css['boxes_text'];?>;  text-shadow: none; } 

.gallerypopup { display: none; position: absolute; width: 360px; left: 50%; top: 0%;margin-left: -180px; background: <?php print inside_bg;?>; z-index:301;  } 
.numberCircle {
    ...
    font-size: 12px;
    line-height: 1em;
    border: 2px solid #<?php print $css['sm_link_color'];?>;
    position: relative;
	display: inline-block;
}
...
.dayscontainer {  border-right: solid 1px #<?php print $css['boxes_borders'];?>;  border-bottom: solid 1px #<?php print $css['boxes_borders'];?>; } 
...
.calday {  padding: 8px;  height: 100%; text-align: center;  border-top: solid 1px #<?php print $css['boxes_borders'];?>;  border-left: solid 1px #<?php print $css['boxes_borders'];?>; } 
.today { color: <?php print inside_bg;?>; background: <?php print font_color;?>; font-weight: bold; } 

.notmonth {color: <?php print inside_bg;?>; } 
...
#sizemenu .menu ul li a {  display:block; margin: 0px 0px 0px 0px; background: #<?php print $css['sm_background'];?>; border-bottom: solid 1px #<?php print $css['sm_border_bottom'];?>; padding: 16px; color: #<?php print $css['sm_link_color'];?>; } 
#sizemenu .menu ul li a .the-icons { color: #<?php print $css['sm_link_color'];?>; text-shadow: none; } 
...
.roomviewmenus { 
		position: fixed; bottom: 0; left: 0; width: 100%; background: #<?php print $css['inside_bg'];?>; z-index: 10000; text-align: center;  box-shadow: -6px 0px 6px rgba(0,0,0,.5); border-top: solid 1px #<?php print $css['inside_bg_border'];?>; 
}

.speech-bubble {
	background-color:  #<?php print $css['inside_bg'];?>;
	border: 1px solid #<?php print $css['inside_bg_border'];?>;
	border-radius: 5px;
	width: 100%;
	max-width: 360px;
	padding: 16px;
...
.bottom {
    border-color: #<?php print $css['inside_bg_border'];?> transparent transparent transparent;
...
#sidethumbsclose { max-width: 480px; height: 40px; width: 100%;  right: 0; top: 0; background: #<?php print $css['inside_bg'];?>; text-align: center;  z-index: 5002; cursor: pointer; } 
#sidethumbsinner { background: #<?php print $css['inside_bg'];?>; box-shadow: -12px -22px 12px rgba(0,0,0,.5); text-align: justify;   -ms-text-justify: distribute-all-lines; text-justify: distribute-all-lines; padding: 12px; min-height: 1200px; }
/* ####### End Wall Designer ######## */
