...
<div class="pc center backtoproductlist backtoproductlisttop"><a href="" class="" onclick="closephotoproduct(); return false;"><span class="the-icons icon-left-open"></span><?php print _back_to_products_; ?></a></div>
...
<div class="center">
	<?php if(($prod['pp_width'] > 0) && ($prod['pp_type'] !== "download") && ($date['green_screen_backgrounds'] <=0) == true) { ?>
	<div class="cropphotoview"><?php if($_REQUEST['mobile'] == 1) {cropphotoview4($cart,$pic,$prod,"pic_pic",'1',$_REQUEST['color_id']);}else{cropphotoviewv2($cart,$pic,$prod,"pic_pic",'1',$_REQUEST['color_id']);} ?></div>
...
<?php showProductv2($prod,$list,$con); ?>
