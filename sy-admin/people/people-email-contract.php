...
$contract = doSQL("ms_contracts","*,date_format(signed_date, '".$site_setup['date_format']." ".$site_setup['date_time_format']."')  AS signed_date,date_format(my_signed_date, '".$site_setup['date_format']." ".$site_setup['date_time_format']." ')  AS my_signed_date,date_format(signed_date2, '".$site_setup['date_format']." ".$site_setup['date_time_format']."')  AS signed_date2,date_format(due_date, '".$site_setup['date_format']." ')  AS due_date","WHERE contract_id='".$_REQUEST['contract_id']."' ");
$person = doSQL("ms_people", "*", "WHERE p_id='".$contract['person_id']."' ");
...
if($_REQUEST['action'] == "sendemail") { 
	...
	$em = doSQL("ms_emails", "*", "WHERE email_id_name='sendcontract' ");
	if(isset($_SESSION['order_id'])) { 
		...
		$to_name = stripslashes($contract['signature_name']);
...
<div class="pc"><h3>Email Contract</h3></div>
		<div id="emailsend">
			<div class="underline">
				<div class="left p50">
