				...
				setFloating: function($image)
				{
					...
					switch (floating)
					{
						...
						case 'full':
							...
							imageMargin = 'auto';
							imageWidth = "100vw";
							imageMarginLeft = "calc(-50vw + 50%)";
							$image.css({margin:'auto', 'margin-left':imageMarginLeft , 'float': 'none', 'max-width':'auto','max-height':'auto',display: imageDisplay, width:imageWidth });
							// alert($image.attr('style'));
					break;
					}

				//	$image.css({ 'float': imageFloat, display: imageDisplay, margin: imageMargin,width:imageWidth, 'margin-left':imageMarginLeft });
...
//								+ '<option value="full">Screen Width</option>'
							+ '</select>'
						+ '</section>',
